...
def crea_codice_nuovo(entry1,entry2,entry3,entry4,entry5,entry6,entry7,entry8,entry9,entry10,entry11):
    var2=entry1.get()
    var3=entry2.get()
    if var2=='' or var3=='':  
        messagebox.showerror('Attenzione', 'Nessun numero trovato')
...
def carica_dati(entry1,entry2,entry3,entry4,entry5,entry6,entry7,entry8,entry9,entry10):
    global base_codice
    ...
    try:
        ...
        with open(str(usb)+':/datichat.txt', 'r') as leggi:
            ...
            indirizzo_ip=str(int(le4))+'.'+str(int(le5))+'.'+str(int(le6))+'.'+str(int(le7))
...
class Finestra1(tk.Tk):
    def __init__(self):
        ...
        #****   crea nuovo codice
        b10 = tb.Button(self, text="Apri Chat", style='success.Outline.TButton', command=self.apri_chat)
        b10.place(x=450,y=600)
        l1=tb.Label(self,text='Inserisci un numero',font='arial 12')
        l1.place(x=10,y=20)
        e2=tb.Entry(self,width=50,justify='center')
        e2.place(x=10,y=40)
        b11 = tb.Button(self, text="Trasforma in Primo", style='success.Outline.TButton', command=lambda:trasforma_primo(e2))
        b11.place(x=10,y=70)
        b12 = tb.Button(self, text="Crea Nuovo Codice", style='success.Outline.TButton', command=lambda:crea_codice_nuovo(e2,e3,e4,e5,e6,e7,e8,e9,e10,e11,e12))
        ...
        l8=tb.Label(self,text='Att.: compilare il campo (IP e Porta) prima di creare nuovo codice',font='arial 12')
        l8.place(x=20,y=300)
        l8=tb.Label(self,text='NB:assegnare la porta USB sempre se quella non corrispone',font='arial 12')
        l8.place(x=20,y=320)
        e12=tb.Entry(self,width=3,justify='center')
        e12.insert(0,'D')
        e12.place(x=450,y=320)
        l9=tb.Label(self,text='****************************************************************************',font='arial 12')
        l9.place(x=20,y=350)
        ...
        b13 = tb.Button(self, text="Carica Dati", style='success.Outline.TButton', command=lambda:carica_dati(ce2,ce9,ce10,ce11,ce4,ce5,ce6,ce7,ce8,e12))
...
class FinestraChat(tk.Toplevel):
    def __init__(self, master):
        ...
        global e1
    #***********************************************************************************
        b11 = tb.Button(self,text='Pulisci', bootstyle='TButton, outline,success',command=puliscitw1)
        b11.place(x=100, y=210)
        b14 = tb.Button(self,text='Pulisci', bootstyle='TButton, outline,success',command=puliscitw4)
        b14.place(x=700, y=500)
    #***********************************************************************************
        b1 = tb.Button(self,text='Codifica', bootstyle='TButton, outline,success',command= codifica)
        b1.place(x=10, y=210)
        b4 = tb.Button(self,text='Decodifica', bootstyle='TButton, outline,success',command=decodifica)
        b4.place(x=10, y=500)
    #***********************************************************************************
        b3 = tb.Button(self,text='Invia', bootstyle='TButton, outline,success',command=manda_tw1)
